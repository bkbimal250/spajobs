...
class EmployeeRegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'gender', 'email', 'password1', 'password2', 'location', 'skills', 'MobileNumber', 'highest_education', 'Experience', 'resume_file']
...
class EmployeeProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ["first_name", "last_name", "gender", "location", "skills", "MobileNumber", "highest_education","Experience", "resume_file"]
